...
```
cd existing_repo
git remote add origin https://gitlab.com/l3587/carro.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/l3587/carro/-/settings/integrations)
